...
int main() {
   ...
   SN_CT_REQUIRE_SAME_TYPENAME< TL_appended, TL_append_proof >();
   ...
   SN_CT_REQUIRE_SAME_TYPENAME< TL_concatenated, TL_concat_proof >();
   ...
   SN_CT_REQUIRE_SAME_TYPENAME< TL_removed, TL_rem_proof >();
   ...
   SN_CT_REQUIRE_SAME_TYPENAME< TL_rem_null, TL_removed_null >();
   ...
   SN_CT_REQUIRE_SAME_TYPENAME< TL_no_dup, TL_dup_proof >();
